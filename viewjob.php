  ...
  ?> 
           <div class="container">
             <div class="mg-available-rooms">
                    <h5 class="mg-sec-left-title">Publicatiedatum :  <?php echo date_format(date_create($result->DATEPOSTED),'M d, Y'); ?></h5>
                                        ...
                                        <div class="row contentbody">
                                            ...
                                            <div class="col-sm-6">
                                                <ul>
                                                    ...
                                                    <li><i class="fp-ht-tv"></i>Geslachts Voorkeur : <?php echo $result->PREFEREDSEX; ?></li>
                                          ...
                                          <a href="<?php echo web_root; ?>index.php?q=apply&job=<?php echo $result->JOBID;?>&view=personalinfo" class="btn btn-main btn-next-tab">Solliciteer !</a>
                                    </div>
                                </div>
                            </div> 
                        </div>
